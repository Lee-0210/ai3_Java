...
public class CalendarEx2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("10일 전 : " + before50Day);
		
		// 50일 전 (roll)
		Calendar cal2 = Calendar.getInstance();
		System.out.println(cal2.DATE);
		System.out.println(cal2.DAY_OF_MONTH);
		System.out.println(cal2.DAY_OF_WEEK);
		cal2.roll(cal2.DAY_OF_MONTH, -5);
		String before50Day2 = sdf.format(cal2.getTime());
		System.out.println("10일 전 : " + before50Day2);

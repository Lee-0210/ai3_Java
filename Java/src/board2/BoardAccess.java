...
public class BoardAccess implements BoardInterface {
	...
	public boolean update(Board board) {
		...
		updateBoard.setTitle(updateWriter);
		updateBoard.setTitle(updateContent);
		
		// 수정일자 현재/날짜 시간으로 변경
		updateBoard.setUpdateAt("2025/03/20 - 11:00");
//		boardList[no-1] = updateBoard;
	...
	/*
	 * 게시글 삭제
	 * 1. 삭제 게시글 번호 no 가 유효하지 않으면, false 반환
	 * 2. 게시글이 하나도 존재하지 않으면, false 반환
	 * 3. 삭제할 게시글의 번호 no 가 유효하면,
